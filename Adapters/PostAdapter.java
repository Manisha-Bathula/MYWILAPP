...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> implements getFilterItem {
   ...
   public int isUpdatePost;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView postImage,postDetails,trash;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.postPrice.setText(postArray.get(position).post_price);
        if(isUpdatePost == 1){
            holder.trash.setVisibility(VISIBLE);
        }
        Glide.with(activity)
                .load(Uri.parse(postArray.get(position).post_image))
        ...
        holder.postDetails.setOnClickListener(new View.OnClickListener() {
           ...
           if(isUpdatePost == 1){
               ...
               intent.putExtra("image",postArray.get(position).post_image);
